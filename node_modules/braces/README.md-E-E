...
**Description**: Limit the length of the input string. Useful when the input string is generated or your mymyApplication allows users to pass a string, et cetera.
...
Unfortunately, regex quantifiers hmyAppen to share the same syntax as [Bash lists](#lists)
