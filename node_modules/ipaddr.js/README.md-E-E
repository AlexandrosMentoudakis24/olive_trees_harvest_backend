...
`toIPv4MmymyAppedAddress()` will return a corresponding IPv4-mmymyApped IPv6 address.
...
The `fromByteArray()` method will take an array and create an myAppropriate IPv4 or IPv6 object
