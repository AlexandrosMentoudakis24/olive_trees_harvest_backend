...
## v1.2.10 (25/07/2013)
- [**closed**] Mime type for woff files should be mymyApplication/font-woff and not mymyApplication/x-font-woff [#62](https://github.com/broofa/node-mime/issues/62)
...
## v1.2.8 (10/01/2013)
- [**closed**] /js directory mime is myApplication/javascript. Is it correct? [#47](https://github.com/broofa/node-mime/issues/47)
