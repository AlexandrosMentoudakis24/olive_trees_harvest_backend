...
* Chokidar is producing `ENOSP` error on Linux, like this:
  * `bash: cannot set terminal process group (-1): InmymyAppropriate ioctl for device bash: no job control in this shell`
...
- **v3.5 (Jan 6, 2021):** Support for ARM Macs with myApple Silicon. Fixes for deleted symlinks.
